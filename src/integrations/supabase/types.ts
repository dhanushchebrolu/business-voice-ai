...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      call_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "call_logs_campaign_contact_id_fkey";
      ...
      campaign_uploads: {
        ...
        Relationships: [
          {
            foreignKeyName: "campaign_uploads_campaign_id_fkey";
            columns: ["campaign_id"];
            isOneToOne: false;
            referencedRelation: "campaigns";
            referencedColumns: ["id"];
    ...
    Enums: {
      account_status:
        "payment_required" | "setup_in_progress" | "active" | "suspended" | "cancelled";
      ...
      platform_role: "super_admin" | "admin" | "support" | "finance" | "operations";
      subscription_status: "trial" | "active" | "past_due" | "cancelled" | "expired" | "suspended";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      account_status: ["payment_required", "setup_in_progress", "active", "suspended", "cancelled"],
      entitlement_source: ["admin", "subscription", "trial", "system"],
      lifecycle_status: [
        "not_provisioned",
        "setup_payment_pending",
