...
export const PLATFORM_FEATURES = [
  {
    ...
    description: "Signing in and using the customer dashboard at all.",
  },
  {
    key: "phone",
    label: "Phone number & calls",
    description: "Assigned number, inbound and outbound calling.",
  },
  {
    key: "voice",
    label: "AI voice agent",
    description: "Publishing and running the voice receptionist.",
  },
  { key: "whatsapp", label: "WhatsApp", description: "WhatsApp inbox and AI replies." },
  {
    key: "instagram",
    label: "Instagram",
    description: "Instagram DM inbox, AI replies and comment automation.",
  },
  { key: "chatbot", label: "Website chatbot", description: "Embeddable website chat widget." },
  {
    key: "campaigns",
    label: "Outbound campaigns",
    description: "CSV campaigns and bulk outbound calling.",
  },
  {
    key: "appointments",
    label: "Appointments",
    description: "Calendar, bookings and staff scheduling.",
  },
] as const;
