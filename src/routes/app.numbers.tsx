            ...
            <div className="rounded-lg border border-border p-4">
              ...
              {active ? (
                ...
                <>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Your number is provisioned and connected by our team once the service is active.
                    Nothing is simulated here — this stays empty until a real number is live on your
                    workspace.
                  </p>
                </>
              )}
